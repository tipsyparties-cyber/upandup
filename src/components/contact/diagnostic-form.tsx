...
export function DiagnosticForm() {
  ...
  return (
    <form action={formAction} className="space-y-6">
      ...
      <div>
        <label htmlFor="business" className="block text-sm font-medium text-warm-grey">
      ...
      <div>
        <label htmlFor="painPoints" className="block text-sm font-medium text-warm-grey">
      ...
      <div>
        <label htmlFor="goals" className="block text-sm font-medium text-warm-grey">
      ...
      <div>
        <label htmlFor="timeWasters" className="block text-sm font-medium text-warm-grey">
      ...
      <div>
        <label htmlFor="budget" className="block text-sm font-medium text-warm-grey">Budget range (optional)</label>
      ...
      <div className="grid gap-6 sm:grid-cols-2">
        <div>
          <label htmlFor="name" className="block text-sm font-medium text-warm-grey">Your name <span className="text-accent">*</span></label>
          <input id="name" name="name" type="text" required className={inputStyles} />
        </div>
        <div>
          <label htmlFor="email" className="block text-sm font-medium text-warm-grey">Email <span className="text-accent">*</span></label>
          <input id="email" name="email" type="email" required className={inputStyles} />
        </div>
      </div>

      <div>
        <label htmlFor="phone" className="block text-sm font-medium text-warm-grey">Phone (optional)</label>
