    ...
    <div className="pt-32 pb-20">
      <section className="px-6">
        <div className="mx-auto max-w-[1280px]">
          <SectionReveal>
            ...
            <h1 className="mt-4 font-serif text-5xl font-light md:text-6xl lg:text-7xl">Tipsy Parties</h1>
      ...
      <section className="mt-24 px-6">
        <div className="mx-auto max-w-3xl">
          <SectionReveal>
            <h2 className="font-serif text-3xl font-light md:text-4xl">The Problem</h2>
      ...
      <section className="mt-24 px-6 gradient-section py-24">
        <div className="mx-auto max-w-[1280px]">
          <SectionReveal>
            <h2 className="font-serif text-3xl font-light md:text-4xl">The System We Built</h2>
            ...
            {automations.map((auto, i) => (
              <SectionReveal key={auto.title} delay={i * 0.05}>
                <GlassPanel className="h-full">
                  <h3 className="font-serif text-lg font-light">{auto.title}</h3>
      ...
      <section className="mt-24 px-6">
        <div className="mx-auto max-w-3xl">
          <SectionReveal>
            <h2 className="font-serif text-3xl font-light md:text-4xl">The Flow</h2>
      ...
      <section className="mt-24 px-6">
        <SectionReveal>
          <div className="mx-auto max-w-2xl text-center">
            <h2 className="font-serif text-3xl font-light md:text-4xl">Want something like this for your business?</h2>
